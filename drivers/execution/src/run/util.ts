 ...
 *
 * Centralizes the `ASP_DEBUG_RUN` gate parsing. Foreground execution no longer
 * routes through the hosted-worker compiler.
 */
export function resolveRunEnvFlags(env: NodeJS.ProcessEnv = process.env): { debugRun: boolean } {
  return {
