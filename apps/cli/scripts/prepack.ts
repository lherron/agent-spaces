...
const WORKSPACES: Array<{ src: string; dest: string; includeBin?: boolean }> = [
  ...
  { src: '../../contracts/harness-broker-protocol', dest: 'spaces-harness-broker-protocol' },
  { src: '../../drivers/harness-claude', dest: 'spaces-harness-claude' },
  { src: '../../drivers/harness-pi', dest: 'spaces-harness-pi' },
  { src: '../../drivers/harness-pi-sdk', dest: 'spaces-harness-pi-sdk' },
  { src: '../../drivers/harness-codex', dest: 'spaces-harness-codex' },
  { src: '../../drivers/harness-muse', dest: 'spaces-harness-muse' },
  { src: '../../drivers/execution', dest: 'spaces-execution' },
  { src: '../../contracts/spaces-runtime-contracts', dest: 'spaces-runtime-contracts' },
  { src: '../../compiler/agent-spaces', dest: 'agent-spaces' },
...
const SPECIFIER_TARGETS: Record<string, string> = {
  ...
  'spaces-harness-muse': 'spaces-harness-muse/dist/index.js',
